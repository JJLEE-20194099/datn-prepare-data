...
def transferMuaban(a, locationql, streets):
   ...
   data_merge = {
               ...
               "propertyBasicInfo": { "landType": { "value": propertyBasicInfo(a) },
                  ...
                  "address": { "value": address_full[0] },
                  "description": { "value": description(a) },
                  "geolocation": { "value":{
                        "latitude": { "value": address_full[1][0] },
                        "longitude": { "value": address_full[1][1] }}},
                  ...
                  "contact": { "name": { "value": a['contact_name'] },
                     "role": "houseOwner",
                     "phoneNumber": { "value": a['phone'] },
                     "avatarUrl": { "value": ' ' }},
                  "price": { "value": a['price']/1000000000 },
